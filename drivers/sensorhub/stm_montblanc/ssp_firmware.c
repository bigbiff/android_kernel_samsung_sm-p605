...
#define SSP_FIRMWARE_REVISION_STM	13082300 /* Latest, 88922*/
#else
#define SSP_FIRMWARE_REVISION_STM	13082400 /* Latest, 88922*/
#endif
...
#define SSP_FIRMWARE_REVISION_STM_W2014	13082400 /* Latest, 88922*/
#define SSP_FIRMWARE_REVISION_STM_W2014_88921	13080800 /* 88921 */
#endif
...
#if defined (CONFIG_SEC_MONTBLANC_PROJECT)
#define BL_FW_NAME_W2014_88921			"ssp_stm_w2014_88921.fw"
#define BL_FW_NAME_W2014			"ssp_stm_w2014.fw"
#endif
...
#if defined (CONFIG_SEC_MONTBLANC_PROJECT)
	if (data->ap_rev > 1)
		return SSP_FIRMWARE_REVISION_STM_W2014;
	else
		return SSP_FIRMWARE_REVISION_STM_W2014_88921;
#else
	if (data->ap_rev > 3)
...
#if defined (CONFIG_SEC_MONTBLANC_PROJECT)
	if (data->ap_rev > 1)
		fw_revision = SSP_FIRMWARE_REVISION_STM_W2014;
	else
		fw_revision = SSP_FIRMWARE_REVISION_STM_W2014_88921;
#elif defined (CONFIG_MACH_HLTEVZW) || defined (CONFIG_MACH_HLTESPR) \
	|| defined (CONFIG_MACH_HLTEUSC)
		if (data->ap_rev > 3)
